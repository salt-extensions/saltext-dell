# Salt Extension for Dell

Salt Extension for interacting with Dell
...
The saltext-dell project team welcomes contributions from the community.
...
```bash
# Clone the repo
git clone --origin salt git@github.com:salt-extensions/saltext-dell.git

# Change to the repo dir
cd saltext-dell

# Create a new venv
python3 -m venv env --prompt saltext-dell
...
* Writing blog posts
* Posting on social media about how you used Salt+Dell to solve your
...
[issues]: https://github.com/salt-extensions/saltext-dell/issues
[PRs]: https://github.com/salt-extensions/saltext-dell/pulls
[discussions]: https://github.com/salt-extensions/saltext-dell/discussions
