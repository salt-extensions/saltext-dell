...
The saltext-dell project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-dell.git
...
* Writing blog posts
* Sharing your experiences using Salt + Dell
  on social media
...
[docs]: https://salt-extensions.github.io/saltext-dell/
